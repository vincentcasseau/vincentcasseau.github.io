...
Please refer to [D. §2.1](https://vincentcasseau.github.io/how-tos-cfd-dev-nonequilibrium/#21-single-vibro-electronic-energy-pool) if you are not familiar with this code feature.  
...
Please refer to [D. §2.2](https://vincentcasseau.github.io/how-tos-cfd-dev-nonequilibrium/#22-multiple-vibro-electronic-energy-pools) if you are not familiar with this code feature.
...
The Maxwell velocity slip BC has been slightly re-written (the [mean free path](https://vincentcasseau.github.io/how-tos-cfd-dev-nonequilibrium/#3-mean-free-path-and-breakdown-parameter) is now calculated according to the model chosen in the <dict>transportProperties</dict> dictionary) and is given by 
...
[**< F. MHD modelling**](https://vincentcasseau.github.io/how-tos-cfd-dev-mhd/)  
