...
<table>
  ...
  <tr>
    ...
    <td align="center"><dictval>LandauTellerVT</dictval> &nbsp; <i class="fa fa-thumbs-up" style="font-size:24px;color:green" title="recommended"></i> <br /> <dictval>noVTEnergyTransfer</dictval>  </td>
    <td align="center">Name of the V—T energy transfer model</td>
  </tr>
  <tr>
    <td align="center"><dictkey>model</dictkey></td>
    <td align="center"><dictval>MillikanWhitePark</dictval> &nbsp; <i class="fa fa-thumbs-up" style="font-size:24px;color:green" title="recommended"></i> <br /> <dictval>MillikanWhite</dictval></td>  
    <td align="center">description</td>
  </tr>
  <tr>  
    <td align="center"><dictkey>fullCoeffsForm</dictkey></td>
    <td align="center"><dictval>on</dictval> &nbsp; <i class="fa fa-thumbs-up" style="font-size:24px;color:green" title="recommended"></i> <br /> <dictval>off</dictval></td>
